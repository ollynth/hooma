...
export default function LoginPage(){
    ...
    return (
      ...
      <div className="min-h-screen flex flex-col bg-secondary-content" style={{ color: 'var(--on-surface)' }}>
          ...
          <div className="card">
            ...
            <>
              ...
              <div className="card-header">
                ...
                <p className="card-header-subtitle">Enter credentials to access your sanctuary.</p>
              </div>
            </>
          </div>
        </main>
